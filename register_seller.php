...
<body>
    ...
    <section class="slider-section pt-4 pb-4">
        <div class="container">
            <form action="proses/register_toko.php" method="POST">
                <div class="mb-3">
                    <label for="storeName" class="form-label">Nama Toko</label>
                    <input type="text" class="form-control" name="nama_toko" id="storeName">
                </div>
                <div class="mb-3">
                    <label for="addressStore" class="form-label">Alamat Toko</label>
                    <textarea class="form-control" name="alamat" id="addressStore" rows="3"></textarea>
                    <input type="hidden" name="id_akun" value="<?php echo $data['id_akun']; ?>">
                </div>
                <div class="mt-5 mb-5">
                    <button type="submit" class="btn btn-primary">Daftar Toko</button>
                </div>
            </form>
        </div>
    </section>
