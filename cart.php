...
//     // foreach ($_POST['barang'] as $checkbox) {
//     for($i=0;$i<count($id_cart);$i++){
//         // $id_cart = $checkbox[$i];
...
//         $checkout = mysqli_query ($koneksi, "INSERT INTO checkout (id_akun,id_toko,id_barang,variasi_order,warna_order,jumlah,subtotal,status_order) VALUES ('$id_akun', '".$id_toko."', '".$id_barang."', '".$variasi_order."', '".$warna_order."', '".$jumlah."', '".$subtotal[$i]."', '".$status_order."') ");
