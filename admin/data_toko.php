              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sql="SELECT * FROM toko,akun,barang WHERE toko.id_akun = akun.id_akun AND toko.id_toko = barang.id_toko";
                    $no =1;
                  ...
                  <tr>
                    ...
                    <td>
                      <?php
                        if (empty($data['foto_toko'])) {
                            echo "Tidak ada Foto";
                        }else{
                            echo "<img src='../img/".$data['foto_toko']."' width='100' height='100'/>";
                        }
                      ?>
                    </td>
                    ...
                    <td>
                      <a href="../proses/hapus.php?id_akun=<?php echo $data['id_toko']; ?>&tipe=toko" class="btn btn-app bg-danger hapus">
  ...
  <div class="modal fade" id="modalInputData" tabindex="-1" role="dialog" aria-labelledby="modalInputData" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form role="form" method="post" action="../proses/tambah_akun.php" enctype="multipart/form-data">
