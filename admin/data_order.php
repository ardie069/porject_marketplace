              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <?php
                    $sql="SELECT * FROM cart, akun, barang WHERE cart.id_akun = akun.id_akun AND cart.id_barang = barang.id_barang";
                    $no = 1;
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="edit_order.php?id_order=<?php echo $data['id_order']; ?>" class="btn btn-app bg-success">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <a href="../proses/hapus.php?id_order=<?php echo $data['id_order']; ?>&tipe=order" class="btn btn-app bg-danger hapus">
