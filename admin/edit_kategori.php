...
<head>
  ...
  <title>Admin | Data Jenis Barang</title>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Edit Data Jenis Barang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <form method="post" action="../proses/update_barang.php" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="jenis_barang" value="<?php echo $tampil['jenis_barang']; ?>">
                  </div>
