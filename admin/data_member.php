                    ...
                    <td>
                      <?php
                        if (empty($data['foto'])) {
                            ...
                            echo "<img src='../img/".$data['foto']."' width='100' height='100'/>";
                        }
                      ?>
                    </td>
                    <td><?php echo $data['status']; ?></td>
                    <td>                      
                      <a href="edit_member.php?id_akun=<?php echo $data['id_akun']; ?>" class="btn btn-app bg-success">
                        <i class="fas fa-edit"></i> Edit
                      </a>
                      <a href="../proses/hapus.php?id_akun=<?php echo $data['id_akun']; ?>&tipe=akun" class="btn btn-app bg-danger hapus">
