...
$sql_barang = "SELECT * FROM barang,toko,stok WHERE barang.id_toko = toko.id_toko AND barang.id_barang = stok.id_barang AND stok.id_stok='$id_stok'";
$hasil=mysqli_query($koneksi, $sql_barang);
...
<body>
    ...
    <!-- edit product -->
    <form method="post" action="proses/update_stok.php" enctype="multipart/form-data">
        <section class="container">
            <h3 class="mt-5">Edit Stok Produk</h3>
            <div class="mb-3">
                ...
                <input type="hidden" name="id_stok" class="form-control" value="<?php echo $tampil['id_stok']; ?>" />
            </div>
            <div class="mb-3">
                <label for="quantity" class="form-label">Stok</label>
                <input type="text" name="stok" class="form-control" value="<?php echo $tampil['stok_barang']; ?>" />
            </div>
            <div class="mb-3">
                <label for="variant" class="form-label">Variasi</label>
                <select class='form-control' name='variasi'>
                    <option value="<?php echo $tampil['variasi_stok']; ?>" selected disabled>
                        <?php echo $tampil['variasi_stok']; ?></option>
                    <option disabled>Pilih Variasi</option>
            ...
            <div class="mb-3">
                ...
                <select class='form-control' name='warna'>
                    <option value="<?php echo $tampil['warna_stok']; ?>" selected disabled>
                        <?php echo $tampil['warna_stok']; ?></option>
