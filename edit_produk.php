...
$sql_barang = "SELECT * FROM barang,toko WHERE barang.id_toko = toko.id_toko AND barang.id_barang='$id_barang'";
$hasil=mysqli_query($koneksi, $sql_barang) or die(mysqli_error($koneksi, $sql_barang));
...
<body>
    ...
    <!-- edit product -->
    <form method="post" action="proses/update_produk.php" enctype="multipart/form-data">
        <section class="container">
            <h3 class="mt-5">Edit Produk</h3>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" value="<?php echo $tampil['deskripsi']; ?>" class="form-control"
                    id="descProduct" rows="3"></textarea>
            </div>
            <div class="mb-3">
                <label for="descProduct" class="form-label">Kategori Produk</label>
                <select class="form-control" name="jenis_barang">
                    <option <?= ($tampil['jenis_barang'] == "") ? 'selected' : '' ?> disabled>-- Pilih Kategori Barang
                        --</option>
                    <option <?= ($tampil['jenis_barang'] == "Elektronik dan Aksesoris") ? 'selected' : '' ?>
                        value="Elektronik dan Aksesoris">Elektronik dan Aksesoris</option>
                    <option <?= ($tampil['jenis_barang'] == "Pakaian dan Aksesoris") ? 'selected' : '' ?>
                        value="Pakaian dan Aksesoris">Pakaian dan Aksesoris</option>
                    <option <?= ($tampil['jenis_barang'] == "Perawatan dan Kecantikan") ? 'selected' : '' ?>
                        value="Perawatan dan Kecantikan">Perawatan dan Kecantikan</option>
                    <option <?= ($tampil['jenis_barang'] == "Perlengkapan Rumah") ? 'selected' : '' ?>
                        value="Perlengkapan Rumah">Perlengkapan Rumah</option>
                    <option <?= ($tampil['jenis_barang'] == "Buku dan Alat Tulis") ? 'selected' : '' ?>
                        value="Buku dan Alat Tulis">Buku dan Alat Tulis</option>
                    <option <?= ($tampil['jenis_barang'] == "Otomotif") ? 'selected' : '' ?> value="Otomotif">Otomotif
                    </option>
                    <option <?= ($tampil['jenis_barang'] == "Barang Digital") ? 'selected' : '' ?>
                        value="Barang Digital">Barang Digital</option>
                    <option <?= ($tampil['jenis_barang'] == "Olahraga") ? 'selected' : '' ?> value="Olahraga">Olahraga
                    </option>
                    <option <?= ($tampil['jenis_barang'] == "Mainan dan Bayi") ? 'selected' : '' ?>
                        value="Mainan dan Bayi">Mainan dan Bayi</option>
                    <option <?= ($tampil['jenis_barang'] == "Hobi dan Koleksi") ? 'selected' : '' ?>
                        value="Hobi dan Koleksi">Hobi dan Koleksi</option>
                </select>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="harga_barang" value="<?php echo $tampil['harga_barang']; ?>"
                    class="form-control" id="price" />
            </div>
            <div class="mb-3">
                <label for="variant" class="form-label">Variasi</label>
                <label class="form-label text-danger">*Tidak boleh ada spasi</label>
                <input type="text" name="variasi" value="<?php echo $tampil['variasi']; ?>" class="form-control"
                    id="variasi" />
                <!-- <button onclick="tambahVarian()" class="btn btn-primary mt-3">Tambah</button> -->
            </div>
            <div class="mb-3" id="tampilanVariasi">
                <ul></ul>
            </div>
            <div class="mb-3">
                ...
                <input type="text" name="warna" value="<?php echo $tampil['warna']; ?>" class="form-control"
                    id="variasi2" />
                <!-- <button onclick="tambahVarian2()" class="btn btn-primary mt-3">Tambah</button> -->
            </div>
            <div class="mb-3" id="tampilanVariasi2">
                <ul></ul>
            </div>
            <div class="mb-5">
